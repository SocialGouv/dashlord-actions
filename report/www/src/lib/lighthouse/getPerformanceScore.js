...
export var getPerformanceScore = function (report) {
  let _a; let _b; let _c; let
    _d;
  const numRequests = ((_a = report.audits.diagnostics.details) === null || _a === void 0 ? void 0 : _a.items)
        && ((_b = report.audits.diagnostics.details) === null || _b === void 0 ? void 0 : _b.items[0].numRequests);
  const totalByteWeight = ((_c = report.audits.diagnostics.details) === null || _c === void 0 ? void 0 : _c.items)
